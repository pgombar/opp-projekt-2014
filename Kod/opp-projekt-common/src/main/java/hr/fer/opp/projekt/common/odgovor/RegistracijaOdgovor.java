...
public final class RegistracijaOdgovor implements Odgovor, Serializable {
    ...
    public RegistracijaOdgovor(Korisnik korisnik) {
        this.korisnik = korisnik;
        this.greske = new ArrayList<>();
    }

    public RegistracijaOdgovor(List<String> greske) {
        this.korisnik = null;
        this.greske = greske;
    }
