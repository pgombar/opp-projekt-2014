...
public final class DodajOmiljenogUmjetnikaOdgovor implements Odgovor, Serializable {
    private static final long serialVersionUID = -6501310805416392781L;

    private final List<Korisnik> omiljeniUmjetnici;

    public DodajOmiljenogUmjetnikaOdgovor(List<Korisnik> omiljeniUmjetnici) {
